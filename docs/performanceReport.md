...
- 🧪 **Query**: `db.restaurants.find({}, {_id: 0}, {grades: {$elemMatch: {score: { $gt: 90}}}})`
- ⏱️ **Execution time**: 0 ms
- 📚 **Documents returned**: 664
- 🔍 **Documents examined**: 664
- 🛠️ **Execution stage**: PROJECTION_SIMPLE
...
- 🧪 **Query**: `db.restaurants.find({_id: 0}, {grades: {$elemMatch: {score: { $gt: 80, $lte: 100}}}})`
- ⏱️ **Execution time**: 0 ms
...
- 🧪 **Query**: `db.restaurants.find({}, {_id: 0}, {"location.coordiantes.0": {$lt: -95.754168}})`
- ⏱️ **Execution time**: 1 ms
- 📚 **Documents returned**: 664
- 🔍 **Documents examined**: 664
- 🛠️ **Execution stage**: PROJECTION_SIMPLE
