...
- 🧪 **Query**: `db.restaurants.find({ $or: [{ $and: [ { cuisine: "Seafood" }, { cuisine: { $nin: ["American", "Chinees"] } }]}, { name: { $regex: "^Wil" }}]}, { _id: 0 })`
- ⏱️ **Execution time**: 1 ms
...
- 🧪 **Query**: `db.restaurants.find({grades: {$elemMatch: {score: { $gt: 80, $lt: 100}}}}, {_id: 0, restaurant_id: 1, name: 1, grades: { $elemMatch: { score: { $gt: 80, $lt: 100} } }})`
- ⏱️ **Execution time**: 1 ms
- 📚 **Documents returned**: 1
- 🔍 **Documents examined**: 664
